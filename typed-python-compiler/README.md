...
**Try it live: [compiler.prabhas.io](https://compiler.prabhas.io)**
...
A web-based UI for this compiler is available at [Compiler UI](https://github.com/prabhask5/compiler-ui). It compiles this Rust compiler to WebAssembly so you can write, compile, and run Typed Python programs entirely in the browser.
