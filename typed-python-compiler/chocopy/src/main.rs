use chocopy::common::location::Location;
use chocopy::common::node::Program;
use chocopy::core::codegen;
use chocopy::core::codegen::Platform;
use chocopy::core::frontend;
use chocopy::core::typecheck;
use getopts::Options;
use std::fs::File;
